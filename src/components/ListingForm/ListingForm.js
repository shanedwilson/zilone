  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps !== this.props && isEditing) {
      listingRequests.getSingleListing(editId)
        ...
        .catch((err) => {
          console.error('error with getSingleListing', err);
        });
    }
  }
    ...
    return (
      ...
      <form onSubmit={this.formSubmit}>
          <div className="form-group">
            ...
            placeholder="123 Main St. Nashville, TN 37216"
          ...
          <div className="form-group">
            ...
            <input
            type="text"
            className="form-control" id="squareFootage"
          ...
          <div className="form-group">
            ...
            <input
            type="text"
            className="form-control" id="numBeds"
          ...
          <div className="form-group">
            ...
            <input
            type="text"
            className="form-control" id="numBaths"
          ...
          <div className="form-group">
            ...
            <input
            type="text"
            className="form-control" id="heating"
          ...
          <div className="form-group">
            ...
            <input
            type="text"
            className="form-control" id="cooling"
